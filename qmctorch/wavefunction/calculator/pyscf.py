...
class CalculatorPySCF(CalculatorBase):
    ...
    #     calc_grp = h5.create_group('calculator')

    #     calc_grp['TotalEnergy'] = rhf.e_tot
    #     calc_grp['radial_type'] = 'gto'
    #     calc_grp['harmonics_type'] = 'cart'
    ...
    #     calc_grp['nao'] = len(mol.cart_labels())
    #     calc_grp['nmo'] = rhf.mo_energy.shape[0]
    ...
    #     calc_grp.create_dataset('nshells', data=nshells)
    #     calc_grp.create_dataset('index_ctr', data=index_ctr)

    #     calc_grp.create_dataset('bas_coeff', data=bas_coeff)
    #     calc_grp.create_dataset('bas_exp', data=bas_exp)
    #     calc_grp.create_dataset('bas_norm', data=bas_norm)

    #     calc_grp.create_dataset('bas_n', data=bas_n)
    #     calc_grp.create_dataset('bas_l', data=bas_l)
    #     calc_grp.create_dataset('bas_kr', data=bas_kr)

    #     calc_grp.create_dataset('bas_kx', data=bas_kx)
    #     calc_grp.create_dataset('bas_ky', data=bas_ky)
    #     calc_grp.create_dataset('bas_kz', data=bas_kz)

    #     # molecular orbitals
    #     mos = mol.cart2sph_coeff() @ rhf.mo_coeff
    #     mos = self.normalize_columns(mos)
    #     calc_grp.create_dataset('mos', data=mos)

    #     # atom coords
    #     calc_grp.create_dataset('atom_coords_internal',
