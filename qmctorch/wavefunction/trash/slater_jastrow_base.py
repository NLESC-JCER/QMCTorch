...
class SlaterJastrowBase(WaveFunction):
    def __init__(
        ...
        super(SlaterJastrowBase, self).__init__(mol.nelec, 3, kinetic, cuda)
        ...
        self.mo_scf = nn.Linear(mol.basis.nao, self.nmo_opt, bias=False)
        ...
        self.pool = SlaterPooling(self.configs_method, self.configs, mol, cuda)
    ...
    def kinetic_energy_jacobi(self, x, **kwargs):
        ...
        raise NotImplementedError("Implement a kinetic_energy_jacobi method")
    ...
    def gradients_jacobi(self, x, pdf=False):
        ...
        raise NotImplementedError("Implement a gradient_jacobi method")
    ...
    def get_gradient_operator(self, x, ao, grad_ao, mo):
        ...
        raise NotImplementedError("Implement a get_grad_operator method")
    ...
    def get_hessian_operator(self, x, ao, dao, d2ao, mo):
        ...
        raise NotImplementedError("Implement a get_kinetic_operator method")
