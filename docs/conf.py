...
latex_documents = [
    (master_doc, 'QMCTorch.tex', 'QMCTorch Documentation',
...
man_pages = [
    (master_doc, 'qmctorch', 'QMCTorch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'QMCTorch', 'QMCTorch Documentation',
     author, 'QMCTorch', 'One line description of project.',
     'Miscellaneous'),
]
