...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_pychamp``)
...
* For convenience, the package version is stored in a single place: ``pyCHAMP/__version__.py``. For updating the version number, you only have to change this file.
...
To install pyCHAMP, do:

.. code-block:: console

  git clone https://github.com/NLESC-JCER/pyCHAMP.git
  cd pyCHAMP
  pip install .
...
If you want to contribute to the development of pyCHAMP,
