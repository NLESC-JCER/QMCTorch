...
eloc = wf(solver.sampling_traj(with_tqdm=True).pos).detach().numpy()
print(np.isnan(np.sum(eloc)))
plot_walkers_traj(eloc)
...
np.save('Li2_HMC.npy', obs.local_energy)
