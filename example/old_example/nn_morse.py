...
from pyCHAMP.solver.mesh import torchify, fgradient
...
class RBF_MORSE(NEURAL_WF_BASE):
    ...
    def __init__(self,nelec=1,ndim=1,ncenter=51):
        ...
        _func = fgradient(torchify(self.nuclear_potential))
        self.centers = torch.tensor(mesh(_func,-2,5,ncenter,loss='curvature'))
