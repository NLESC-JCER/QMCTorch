...
from pyCHAMP.wavefunction.slater_orbitals import STO
...
class STO_H2(NEURAL_WF_BASE):
    ...
    def nuclear_potential(self,pos):
        ...
        for ielec in range(self.nelec):
            ...
            for iatom in range(self.natom):
                patom = self.sto.atom_coords[iatom,:]
    ...
    def nuclear_repulsion(self):
        c0 = self.sto.atom_coords[0,:]
        c1 = self.sto.atom_coords[1,:]
...
def pos_curve(net,X = np.linspace(0.2,1.5,11)):
    ...
    for x in X:
        ...
        net.wf.sto.atom_coords.data[0,2] = -x
        net.wf.sto.atom_coords.data[1,2] = x
...
def single_point(net,x=0.69,loss='variance',alpha=0.01):
    ...
    net.wf.sto.atom_coords.data[0,2] = -x
    net.wf.sto.atom_coords.data[1,2] = x
    net.wf.sto.atom_coords.requires_grad = True
    ...
    for i in range(2):
        x,y,z = net.wf.sto.atom_coords.data[i,:].numpy()
        u,v,w = net.wf.sto.atom_coords.grad.data[i,:].numpy()
...
def geo_opt(net,x=1.25,sigma=1.24,loss='energy'):
    ...
    net.wf.sto.atom_coords.requires_grad = True
    net.wf.sto.bas_exp.requires_grad = False
...
if __name__ == "__main__":
    ...
    # define the RBF WF
    mol = Molecule(atom='H 0 0 -0.37; H 0 0 0.37',basis='sz')
    wf = STO_H2(mol)
